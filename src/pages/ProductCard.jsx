        ...
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
            <div className="group relative">
              ...
              <button className="mt-4 w-full bg-pink-600 border border-transparent rounded-md shadow-2xl py-2 px-8 flex items-center justify-center text-sm font-medium text-white  ">
                Add to Cart
              </button>
            </div>
            <div className="group relative">
              ...
              <button className="mt-4 w-full bg-pink-600 border border-transparent rounded-md py-2 px-8 flex items-center justify-center text-sm font-medium text-white  shadow-2xl ">
                Add to Cart
              </button>
            </div>
            <div className="group relative">
